...
namespace PrimitiveTypesToBinary
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Convert.ToString(char1, 10));
            Console.WriteLine(Convert.ToString(120, 2));

            Console.WriteLine(Convert.ToString(char2, 10));
            Console.WriteLine(Convert.ToString(36, 2));
        }
    }
}
